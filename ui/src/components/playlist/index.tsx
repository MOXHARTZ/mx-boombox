...
const Playlist = () => {
    ...
    return (
        <section ref={animationParent} className='bg-zinc-600 p-4 rounded-lg mt-5 gap-4 flex flex-col overflow-auto md:min-h-[calc(100vh-24rem)] xl:max-h-[calc(100vh-16rem)] sm:max-h-[calc(100vh-24rem)]'>
            {playlist.map(song => (
